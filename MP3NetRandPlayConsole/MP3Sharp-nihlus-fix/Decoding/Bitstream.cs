...
namespace MP3Sharp.Decoding
{
    ...
    internal sealed class Bitstream
    {
        ...
        /// <summary>
        /// The MP3 stream associated with this BitStream. - ggocek 11/2023
        /// </summary>
        public MP3Stream myMP3Stream { get; set; }

        /// <summary>
        /// ggocek 12/2023 avoid throwing an exception
        /// </summary>
        ...
        private Header readNextFrame()
        {
            if (m_FrameSize == -1)
            {
                ...
                this.IsEof = false; // ggocek 12/2023 return to avoid throwing an exception
                m_Header.read_header(this, m_CRC); // original code
                // Following IF: ggocek 12/2023 return null to avoid throwing an exception
                if (this.IsEof)
                {
                    m_Header = null;
                }
        ...
        internal int syncHeader(sbyte syncmode)
        {
            ...
            if (bytesRead != 3)
            {
                ...
                return BitstreamErrors.EOF_NOT_ERROR; // ggocek 12/2023 return to avoid throwing an exception
            }
        ...
        public bool isSyncMark(int headerstring, int syncmode, int word)
        {
            ...
            if (sync)
            {
                ...
                if (!sync) myMP3Stream.InvalidSampleRates++;
            ...
            if (sync)
            {
                ...
                if (!sync) myMP3Stream.InvalidLayers++;
            ...
            if (sync)
            {
                ...
                if (!sync) myMP3Stream.InvalidVersions++;
