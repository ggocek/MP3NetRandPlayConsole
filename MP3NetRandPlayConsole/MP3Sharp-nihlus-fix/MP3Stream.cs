...
namespace MP3Sharp
{
    ...
    public class MP3Stream : Stream
    {
        ...
        /// <summary>
        /// The number of times an invalid sample rate was noticed in an MP3 stream's block.
        /// </summary>
        public int InvalidSampleRates { get; set; }

        /// <summary>
        /// The number of times an invalid layer was noticed in an MP3 stream's block.
        /// </summary>
        public int InvalidLayers { get; set; }

        /// <summary>
        /// The number of times an invalid version was noticed in an MP3 stream's block.
        /// </summary>
        public int InvalidVersions { get; set; }

        /// <summary>
        /// The number of times readfully was noticed in an MP3 stream's block.
        /// </summary>
        public int ReadFullys { get; set; }

        /// <summary>
        /// The number of times zero bytes read was noticed in an MP3 stream's block.
        /// </summary>
